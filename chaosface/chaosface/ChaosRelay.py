...
class ChaosRelay(flx.Component):
	...
	bot_name = flx.StringProp(get_attribute(chaosConfig, "bot_name", "yourbot"), settable=True)
	...
	def openConfig(self, configFile):
		...
		self.set_bot_name(get_attribute(self.chaosConfig, "bot_name", "your-bot"))
		self.set_bot_oauth(get_attribute(self.chaosConfig, "bot_oauth", "oauth:abcdefghijklmnopqrstuvwxyz1234"))
		self.set_channel_name(get_attribute(self.chaosConfig, "channel_name", "your-channel"))
		logging.info('self.chaosConfig["channel_name"] = ' + ChaosRelay.chaosConfig["channel_name"])
		logging.info('channel_name = ' + self.channel_name)
