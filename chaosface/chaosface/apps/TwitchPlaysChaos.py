...
"""
  This file is Blegas's original file for Twitch Plays Chaos. It has _not_ been updated for the
  Chaos Unbound engine and thus won't work. Updating this (or integrating it with TCC) is on
  the to-do list.
"""
